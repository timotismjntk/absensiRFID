  ...
  return (
    <SafeAreaView edges={['bottom', 'left', 'right']} style={styles.container}>
      ...
      <View style={styles.wrapper}>
        <Text style={styles.headerTitle}>Pilih Menu</Text>
        <RectButton
          onPress={() => navigation.navigate('PilihJenisAbsen')}
          style={styles.btn}>
          <Text style={styles.btnTitle}>Mulai Absen</Text>
        </RectButton>
        <RectButton
          onPress={() => navigation.navigate('InputSiswaTidakHadir')}
          style={styles.btn}>
          <Text style={styles.btnTitle}>Input Siswa yang tidak hadir</Text>
        </RectButton>
      </View>
    </SafeAreaView>
  );
