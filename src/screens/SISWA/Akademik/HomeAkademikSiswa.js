...
export default function HomeAkademikSiswa({navigation}) {
  const menu = useRef([
    {
      id: 1,
    ...
    },
    {
      ...
      fn: () => navigation.navigate('JadwalPelajaran'),
    },
    {
      id: 3,
      icon: require('../../../assets/icons2/pertemuan.png'),
      title: 'Pertemuan',
      fn: () => navigation.navigate('ListPertemuan'),
    },
    {
      id: 4,
      icon: require('../../../assets/icons2/koleksiMateri.png'),
      title: 'Koleksi Materi',
      fn: () => navigation.navigate('KoleksiMateri'),
    },
  ]).current;
